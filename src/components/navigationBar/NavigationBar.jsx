...
const NavigationBar = ({ setMobileState, setOpenState }) => {
    ...
    return (
        <>
            <div className={`${isMobile ? 'navigate-bar-container-overlay' : 'hide'} ${!isOpen ? 'hide' : ''}`} onClick={handleClick} />
            ...
            {isMobile &&
                <>
                    ...
                    <button
                        className={`navigate-bar-button ${isOpen ? 'open' : 'origin'}`}
                        onClick={handleClick}
            ...
            {!isMobile &&
                <>
                    <div className={`${!isMobile ? 'navigate-bar-container-overlay-desktop' : 'hide'} ${!isOpen ? 'hide' : ''}`} onMouseEnter={handleClick} />
                    <div className={`navigate-bar-container-desktop ${isOpen ? 'open' : ''}`} onMouseEnter={() => {setIsOpen(true); setOpenState(true); }}>
                        <div className={isOpen ? 'navigate-bar-content-container hide-scroll-container' : ''}>
                            <div className="navigate-bar-content-container-detail">
                                <label className={`fs-7 fw-bold mb-2 ${isOpen ? '' : 'invisible'}`}>General</label>

                                <div
                                    className={`navigate-bar-content fw-bold fs-6 all-center ${isOpen ? 'justify-content-start' : ''} p-2 ${selectedMenu === "home" && !collapseMenu.home ? 'selected' : ''}`}
                                    onClick={() => handleMenuClick("home")}
                                >
                                    <FaHome className={`navigate-bar-icon ${isOpen ? '' : 'collapsed'}`} />
                                    <label className={`${isOpen ? '' : 'hide'}`}>Home</label>
                                    {selectedMenu === "home" ? (
                                        collapseMenu.home ? (
                                            <ExpandMoreIcon className={`navigate-bar-content-status ${isOpen ? '' : 'hide'}`} />
                                        ) : (
                                            <ExpandLessIcon className={`navigate-bar-content-status ${isOpen ? '' : 'hide'}`} />
                                        )
                                    ) : (
                                        <ExpandMoreIcon className={`navigate-bar-content-status ${isOpen ? '' : 'hide'}`} />
                                    )}
                                ...
                                <div className={`navigate-bar-subcontent-container font-custom-2 fs-8 d-flex flex-column ${!collapseMenu.home && isOpen ? 'show' : ''}`}>
                                    <span className="navigate-bar-subcontent p-2" onClick={() => handleNavi('/dashboard')}
                                        style={location.pathname === '/dashboard' ? { cursor: 'not-allowed', color: 'gray' } : {}}>
                                        Dashboard
                                    </span>
                                ...
                                <div
                                    className={`navigate-bar-content fw-bold fs-6 all-center  ${isOpen ? 'justify-content-start' : ''} p-2 ${selectedMenu === "orderhistory" && !collapseMenu.orderhistory ? 'selected' : ''}`}
                                    onClick={() => handleMenuClick("orderhistory")}
                                >
                                    <MdHistory className={`navigate-bar-icon ${isOpen ? '' : 'collapsed'}`} />
                                    <label className={`${isOpen ? '' : 'hide'}`}>Order History</label>
                                    {selectedMenu === "orderhistory" ? (
                                        collapseMenu.orderhistory ? (
                                            <ExpandMoreIcon className={`navigate-bar-content-status ${isOpen ? '' : 'hide'}`} />
                                        ) : (
                                ...
                                <div className={`navigate-bar-subcontent-container font-custom-2 fs-8 d-flex flex-column ${!collapseMenu.orderhistory && isOpen ? 'show' : ''}`}>
                                    <span className="navigate-bar-subcontent p-2" onClick={() => handleNavi('/order')}
                                        style={location.pathname === '/order' ? { cursor: 'not-allowed', color: 'gray' } : {}}>
                                        Order
                                    </span>
                                ...
                                <div
                                    className={`navigate-bar-content fw-bold fs-6 all-center  ${isOpen ? 'justify-content-start' : ''} p-2 ${selectedMenu === "installmenthistory" && !collapseMenu.installmenthistory ? 'selected' : ''}`}
                                    onClick={() => handleMenuClick("installmenthistory")}
                                >
                                    <FaFileAlt className={`navigate-bar-icon ${isOpen ? '' : 'collapsed'}`} />
                                    <label className={`${isOpen ? '' : 'hide'}`}>Installment History</label>
                                    {selectedMenu === "installmenthistory" ? (
                                        collapseMenu.installmenthistory ? (
                                            <ExpandMoreIcon className={`navigate-bar-content-status ${isOpen ? '' : 'hide'}`} />
                                        ) : (
                                ...
                                <div className={`navigate-bar-subcontent-container font-custom-2 fs-8 d-flex flex-column ${!collapseMenu.installmenthistory && isOpen ? 'show' : ''}`}>
                                    <span className="navigate-bar-subcontent p-2" onClick={() => handleNavi('/installmentdocument')}
                                        style={location.pathname === '/installmentdocument' ? { cursor: 'not-allowed', color: 'gray' } : {}}>
                                        Installment Document
                                    </span>
                                ...
                                <div className={`navigate-bar-content fw-bold fs-6 all-center  ${isOpen ? 'justify-content-start' : ''} p-2`} onClick={() => handleNavi('/ordertracking')}>
                                    <FaTruck className={`navigate-bar-icon ${isOpen ? '' : 'collapsed'}`} />
                                    <label className={`${isOpen ? '' : 'hide'}`}>Order Tracking</label>
                                </div>
                            </div>
                        </div>
