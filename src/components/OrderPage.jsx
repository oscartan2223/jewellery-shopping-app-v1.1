                ...
                <div className="order-form">
                    ...
                    <div className="order-container">
                        <h3 className="order-content-header">Order History
                            {!collapseOrder ? <ExpandLessIcon className="order-content-header-icon" onClick={() => { setCollapseOrder(!collapseOrder) }} />
                                : <ExpandMoreIcon className="order-content-header-icon" onClick={() => { setCollapseOrder(!collapseOrder) }} />} </h3>
                        <div className={collapseOrder ? 'hide' : ''}>
